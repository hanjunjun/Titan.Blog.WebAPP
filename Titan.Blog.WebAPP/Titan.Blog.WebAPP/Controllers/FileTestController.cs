...
namespace Titan.Blog.WebAPP.Controllers
{
    ...
    public class FileTestController: ApiControllerBase
    {
        ...
        public FileResult downloadRequest()
        {
            ...
            string webRootPath = _hostingEnvironment.WebRootPath;
            string contentRootPath = _hostingEnvironment.ContentRootPath;
            var addrUrl = webRootPath+ @"\Files\UploadFiles\e2711f7a-f0a2-422f-9ccb-1958e10a9e9d.json";

            var stream = System.IO.File.OpenRead(addrUrl);

            string fileExt = Path.GetExtension("e2711f7a-f0a2-422f-9ccb-1958e10a9e9d.json");
