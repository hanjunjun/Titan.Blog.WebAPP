...
function LoadExportApiWordBtn() {
    ...
    $(".topbar").height(35);
    var btnExport = "<div class='selectBox' style='position: relative;margin: 0;padding: 0;margin-left: 1432px;top: -339px;'>" +
        "<span><a href='javascript:void(0);'>导出文档</a></span>" +
        "<div class='drop'>" +
        ...
        "</li >" +
        "<li>" +
        "<a href='javascript:void(0);' onclick='ExportApiWord(4)'>导出到Gif</a>" +
        "</li >" +
        "</ul >" +
        "</div >" +
        "</div >";
...
/*
 * 导出
 * type 1:Word 2:PDF 3:Html 4:Gif
 */
function ExportApiWord(type) {
    ...
    var url = '/api/Swagger/ExportApiWord?type=' + type + "&version=" + version;
    ...
    xhr.onload = function () {
        ...
        if (this.status === 200) {
            ...
            reader.onload = function(e) {
                ...
                a.download = 'Titan.Blog.WebAPP API文档' + exten;
